...
class TestStrategy(unittest.TestCase):
    ...
    def test_moving_average_cross_strategy(self):
        ...
        self.assertEqual(
            result_df["Signal"].iloc[3], 0
        )  # MA_2 (13.5) < MA_4 (13.0) - this is wrong, should be 1
    ...
    def test_strategy_factory(self):
        ...
        ma_cross_strategy = factory.get_strategy(
            "ma_cross", short_window=5, long_window=10
        )
